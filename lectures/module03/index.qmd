...
_daily_carry = (_aud_rate - _jpy_rate) / 365  # annualised % → daily %
...
# daily carry: annualised rate differential / 365 calendar days
...
#| eval: true
_spot_ret = _log_ret
_daily_carry_plot = (_aud_rate - _jpy_rate) / 365

fig, axes = plt.subplots(3, 1, figsize=(10, 7))
_spot_ret.plot(ax=axes[0], title="Spot Return (%)", alpha=0.7, color="steelblue")
axes[0].set_ylabel("%")
_daily_carry_plot.plot(ax=axes[1], title="Daily Carry (annualised differential / 365)", color="darkorange")
axes[1].set_ylabel("%")
