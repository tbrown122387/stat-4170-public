...
## Real Order Flow: SPY Trades, 2026-08-12

`data/20260812_spy.txt` is a full day of raw SPY market data — 2.37M timestamped lines. Most are quote (bid/ask) updates, but 471,265 of them are **trade prints** (`last=`), each with a microsecond timestamp:

```
MarketData(ticker=SPY, time=2026-08-12 09:04:35.122803, last=652.58, size=100, exchange=BATS)
```
...
ax.set_ylabel("N(t)")
ax.set_title("SPY Trade Arrivals, 2026-08-12")
ax.legend()
plt.tight_layout()
plt.show()
```
